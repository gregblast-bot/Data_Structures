...
private:
  // Initialize variables needed, length for the size of the linked list
  // And a generic Node pointer to the beginning (head) of the linked list
  unsigned int length;
  Node<T>* head;
  //Node* tail; For a doubly linked list
