...
private:
	...
	// A palindrome string
	std::vector<std::string> palindromeString;
	// An empty vector string to pass into the recursive algorithm
	std::vector<std::string> Empty;
	// For found palindromes that are sentences
	std::vector<std::vector<std::string>> palindromeVector;
	// Holds the number of palindromes
	int num;
